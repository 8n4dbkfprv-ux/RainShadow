...
#ifndef RAINSHADOW_SWIFT_H
#define RAINSHADOW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RainShadow",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// Plate is aspect-locked to <code>hud_left_rail_plate_v03</code> (never non-uniformly stretched).
SWIFT_CLASS("_TtC10RainShadow13ActionBarNode")
@interface ActionBarNode : SKNode
...
@class NSApplication;
SWIFT_CLASS("_TtC10RainShadow11AppDelegate")
...
SWIFT_CLASS("_TtC10RainShadow14AreaMapOverlay")
@interface AreaMapOverlay : SKNode
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end

@class SKView;
SWIFT_CLASS("_TtC10RainShadow13BaseGameScene")
...
@class NSEvent;
@interface BaseGameScene (SWIFT_EXTENSION(RainShadow))
...
SWIFT_CLASS("_TtC10RainShadow25CaseIntroductionPresenter")
@interface CaseIntroductionPresenter : SKNode
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC10RainShadow25ClassicMacCloseButtonNode")
@interface ClassicMacCloseButtonNode : SKNode
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtC10RainShadow15ClientActorNode")
@interface ClientActorNode : SKNode
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC10RainShadow18DetectiveActorNode")
@interface DetectiveActorNode : SKNode
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC10RainShadow20DetectiveOfficeScene")
@interface DetectiveOfficeScene : BaseGameScene
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)update:(NSTimeInterval)currentTime;
@end

SWIFT_CLASS("_TtC10RainShadow21DialogueScrollbarNode")
@interface DialogueScrollbarNode : SKNode
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end

@class NSBundle;
SWIFT_CLASS("_TtC10RainShadow18GameViewController")
...
/// Case copy for M01 comes from <code>EmptyCoatJournalContent</code> (GDD §4.3.2 dossier).
SWIFT_CLASS("_TtC10RainShadow14JournalOverlay")
@interface JournalOverlay : SKNode
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC10RainShadow15PortraitBarNode")
@interface PortraitBarNode : SKNode
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
