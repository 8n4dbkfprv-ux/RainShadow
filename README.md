...
5. Open the inventory by clicking or tapping Elias's portrait on the right-side HUD. On macOS, `I` also toggles the inventory, arrows/WASD move its selection, and Return/Space/Escape closes it.
