# Harlan Voss portrait-first Imagine V19

Generated 2026-08-09. V19 is a fresh Grok Imagine 2.0 portrait-first redo for Harlan
Voss. Portrait identity is law. Installed V18 remains the runtime authority until
a successful V19 transaction; V18 trees are never overwritten by V19 scaffolding.

## Authoritative references

Immutable copies under `PreRendered3DV19/References/` (hashes in
`voss_v19_manifest.json`):
...
7. Full stage → QA → transactional install (`--confirm-runtime-replace V19`).
