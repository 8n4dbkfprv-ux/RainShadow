...
APERTURES: dict[str, tuple[int, int]] = {
    ...
    "city_door_dock_shed": (140, 460),
    "city_door_lila_rooms": (129, 525),
    "city_door_lila_rooms_b": (249, 560),
    "city_door_lila_neighbor": (203, 570),
    "city_door_lila_opposite": (232, 490),
    "city_door_lila_alcove": (211, 455),
    "city_door_pd_station": (250, 532),
    "city_door_pd_annex": (166, 542),
    "city_door_pd_alley": (142, 486),
    "city_door_records_annex": (250, 466),
    "city_door_records_wing": (145, 500),
    "city_door_records_colonnade": (250, 440),
