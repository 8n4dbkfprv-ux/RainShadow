#!/usr/bin/env python3
"""Build the HUD map from the registered V12 reference-faithful plate."""
...
SOURCE = ROOT / "ArtSource/Generated/Office/BGEEReferenceV12/office_reference_rebuild_plate_v12.png"
GENERATED = ROOT / "ArtSource/Generated/UI/Map/map_detective_office_v12.png"
TARGET = (1847, 1040)
...
def main() -> None:
    ...
    if image.size != (4096, 2304):
        raise RuntimeError(f"expected registered 4096x2304 V12 plate, got {image.size}")
