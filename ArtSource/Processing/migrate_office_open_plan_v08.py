#!/usr/bin/env python3
"""Remove retired door/partition props and register the sole V08 entrance leaf."""
...
def main() -> None:
    ...
    PROP_MANIFEST.write_text(json.dumps(manifest, indent=2) + "\n")
    AREA_RECORD.write_text(json.dumps(area_record, indent=2, sort_keys=True) + "\n")
