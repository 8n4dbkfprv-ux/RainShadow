#!/usr/bin/env python3
"""V10 Lila March hair/age/bust refresh: process PreRendered3DV10 masters with V7 crunch.
...
CLIENT_SOURCE = ROOT / "ArtSource/Generated/Characters/Client/PreRendered3DV10"
...
BACKUP = ROOT / "ArtSource/Generated/Characters/RuntimeBackupLilaPreRendered3DV9"

LILA_ATLAS = "LilaArrival.atlas"


def keyed(source_dir: Path, stem: str) -> Path:
    chroma = source_dir / f"{stem}_chroma_v10.png"
    rgba = source_dir / f"{stem}_rgba_v10.png"
...
def save_frame_v10(frame: Image.Image, atlas_name: str, filename: str, source_dir: Path) -> None:
    registered_dir = source_dir / "Registered_v10"
...
def make_previews_v10() -> None:
    ...
    out = CLIENT_SOURCE / "preview_lila_v10.png"
    ...
    office.convert("RGB").save(
        ROOT / "ArtSource/Generated/Characters/preview_characters_in_office_v10.png",
        optimize=True,
    )
...
def main() -> None:
    ...
    cells = 9 + 8 + 8
    print(
        f"Registered {cells} V10 Lila atlas cells (V7 crunch) from {CLIENT_SOURCE.name}; "
