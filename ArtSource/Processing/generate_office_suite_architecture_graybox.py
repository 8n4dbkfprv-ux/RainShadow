...
Clean isometric wall planes only:
...
def iso_box_ew(
    ...
    g0 = (x0, iy(y_ground))
    g1 = (x1, iy(y_ground))
    s0 = (x0 - face_h * SKEW, iy(y_ground) - face_h)
    s1 = (x1 - face_h * SKEW, iy(y_ground) - face_h)
    n0 = (x0 - face_h * SKEW, iy(y_ground + thick) - face_h)
    n1 = (x1 - face_h * SKEW, iy(y_ground + thick) - face_h)
    ...
    wh = face_h * wain_frac
    w0 = (x0 - wh * SKEW, iy(y_ground) - wh)
    w1 = (x1 - wh * SKEW, iy(y_ground) - wh)
...
def iso_box_ns(
    ...
    g0 = (x, iy(y0))
    g1 = (x, iy(y1))
    t0 = (x - face_h * SKEW, iy(y0) - face_h)
    t1 = (x - face_h * SKEW, iy(y1) - face_h)
    eg0 = (x + thick, iy(y0))
    eg1 = (x + thick, iy(y1))
    et0 = (x + thick - face_h * SKEW, iy(y0) - face_h)
    et1 = (x + thick - face_h * SKEW, iy(y1) - face_h)

    draw.polygon([t0, t1, et1, et0], fill=shade(plaster, -22) + (250,))
    draw.polygon([g0, g1, t1, t0], fill=plaster + (252,))
    wh = face_h * wain_frac
    w0 = (x - wh * SKEW, iy(y0) - wh)
    w1 = (x - wh * SKEW, iy(y1) - wh)
    draw.polygon([g0, g1, w1, w0], fill=wainscot + (254,))
...
def main() -> None:
    ...
    g0 = (lx0, iy(ly))
    g1 = (lx1, iy(ly))
    t0 = (lx0 - lintel_face * SKEW, iy(ly) - lintel_face)
    t1 = (lx1 - lintel_face * SKEW, iy(ly) - lintel_face)
    t2 = (lx1 + PART_W - lintel_face * SKEW, iy(ly) - lintel_face)
    t3 = (lx0 + PART_W - lintel_face * SKEW, iy(ly) - lintel_face)
    draw.polygon([g0, g1, t1, t0], fill=plaster + (252,))
