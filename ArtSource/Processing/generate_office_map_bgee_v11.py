#!/usr/bin/env python3
"""Build the HUD map from the registered V11 1950s-office plate."""
...
SOURCE = (
    ROOT
    / "ArtSource/Generated/Office/BGEE1950sV11/office_1950s_plate_v11.png"
)
GENERATED = ROOT / "ArtSource/Generated/UI/Map/map_detective_office_v11.png"
# Stable runtime/save alias; the version belongs to the source lane, not callers.
...
def main() -> None:
    ...
    if image.size != (4096, 2304):
        raise RuntimeError(f"expected registered 4096x2304 V11 plate, got {image.size}")
