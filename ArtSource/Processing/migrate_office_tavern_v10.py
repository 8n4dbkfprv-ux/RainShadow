#!/usr/bin/env python3
"""Migrate live props into the V10 tavern-hall geometry."""
...
def relocated_ground_points(props: list[dict]) -> dict[str, dict[str, float]]:
    ...
    points.update({
        ...
        "office_entrance_runner": map_point(room.authored(0.18, 0.82)),
...
def main() -> None:
    ...
    manifest_tmp = PROP_MANIFEST.with_name(PROP_MANIFEST.name + ".v10-installing")
    area_tmp = AREA_RECORD.with_name(AREA_RECORD.name + ".v10-installing")
