#!/usr/bin/env python3
"""Build the V09 HUD map from the registered cramped-office composite."""
...
# `map_detective_office_v08` remains the public texture alias for save/runtime
# compatibility; the versioned master is V09.
SOURCE = ROOT / "ArtSource/Generated/Office/office_cramped_v09_preview.png"
GENERATED = ROOT / "ArtSource/Generated/UI/Map/map_detective_office_v09.png"
...
def main() -> None:
    ...
    if image.size != (4096, 2304):
        raise RuntimeError(f"expected registered 4096x2304 preview, got {image.size}")
