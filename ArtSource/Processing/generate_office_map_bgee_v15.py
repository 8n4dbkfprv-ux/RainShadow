#!/usr/bin/env python3
"""Build the HUD map from the final furnished V15 office plate."""
...
SOURCE = (
    ...
    / "office_suite_plate_baked_v15.png"
)
GENERATED = ROOT / "ArtSource/Generated/UI/Map/map_detective_office_v15.png"
TARGET = (1847, 1040)
...
def main() -> None:
    ...
    if image.size != (4096, 2304):
        raise RuntimeError(f"expected registered 4096x2304 V15 plate, got {image.size}")
