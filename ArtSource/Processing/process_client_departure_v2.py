#!/usr/bin/env python3
"""Build Vivian's corrected alternating-leg northeast departure cycle."""
...
SOURCE_DIR = ROOT / "ArtSource/Generated/Characters/Client/DepartureNEV2"
MASTER_DIR = SOURCE_DIR / "Registered_v02"
RUNTIME_DIR = ROOT / "RainShadow Shared/Resources/Art/Atlases/ClientArrival.atlas"
PREVIEW = SOURCE_DIR / "preview_client_departure_ne_v02_registered.png"
ANIMATED_PREVIEW = SOURCE_DIR / "preview_client_departure_ne_v02.gif"
...
def main() -> None:
    poses = [
        ...
        load_pose(SOURCE_DIR / "client_departure_ne_contact_b_rgba_v02.png"),
        load_pose(SOURCE_DIR / "client_departure_ne_pass_b_rgba_v02.png"),
    ]
