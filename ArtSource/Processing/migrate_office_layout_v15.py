#!/usr/bin/env python3
"""Install V15 prop positions idempotently from the frozen V14 prop source."""
...
# Static scenery is baked into the V15 plate. Only the desk cluster remains
# live because it must sort around seated Voss at runtime.
LIVE_PROP_IDS = {
    "office_desk_bare",
    "office_desk_chair",
...
def _atomic_json_write(path: Path, document: dict) -> None:
    temporary = path.with_name(path.name + ".v15-installing")
