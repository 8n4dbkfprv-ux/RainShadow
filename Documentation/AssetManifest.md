...
| **P0** | **`Resources/Dialogue/strings.en.json`** | Dialogue string table (IE TLK analogue): key → prose for graph `textKey` / `speakerKey` / journal text. Locale `en`. See [Dialogue System Roadmap](DialogueSystemRoadmap.md) Phase 4.5. |
