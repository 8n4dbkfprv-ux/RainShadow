...
| P0 | `ui_selection_ring_party` | 1 | 128×64 | **Shipped.** Green underfoot PC/party selection ring (always-on identity marker). Canvas follows `ie_projection.ACTIVE`. |
