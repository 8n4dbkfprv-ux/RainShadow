...
enum GameArt {
    ...
    static func preloadOfficeAssets() {
        let textureNames = [
            "hud_left_rail_plate_v02",
            "hud_right_rail_plate_v02",
            "hud_portrait_frame_v02",
            "hud_action_menu_v02",
            "hud_action_map_v02",
            ...
            "dialogue_outer_frame_overlay_v03",
            "dialogue_command_button_plate_v02",
            "dialogue_scroll_up_v02",
            "dialogue_scroll_down_v02",
            "dialogue_scroll_track_v02",
            "dialogue_scroll_thumb_v02",
            "dialogue_portrait_lila_march_v01",
            "dialogue_portrait_harlan_voss_v01",
            "inventory_outer_frame_overlay_v02",
            ...
            "journal_casebook_plate_v02",
            "journal_row_marker_v02",
