...
enum GameArt {
    ...
    static func preloadOfficeAssets() {
        let textureNames = [
            ...
            "city_sable_row_area_streets_v01",
            "city_sable_lot_harborWest",
            "city_sable_lot_harborVoss",
            "city_sable_lot_upperWest",
            "city_sable_lot_upperEast",
            "city_sable_lot_southWest",
            "city_sable_lot_southEast",
            "city_sable_lot_skylineWest",
            "city_sable_lot_skylineEast",
            "city_sable_lot_edge_1_1",
            "city_sable_lot_edge_0_0",
            "city_sable_lot_edge_3_-2",
            "city_sable_lot_edge_2_-3",
            ...
            "office_door_leaf_mid_hover",
            "office_door_leaf_open",
            "office_door_leaf_open_hover",
            "office_desk_chair",
